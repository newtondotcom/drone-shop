const translations = {
  "en": {
    ...
    "company_description": "DronInside is a video production company based in the Parisian region. We specialize in drone video tours for real estate, businesses, hotels, offices, venues, and much more!",
  ...
  "fr": {
    ...
    "company_description": "DronInside est une entreprise de production vidéo basée en région parisienne. Nous sommes spécialisés dans les vidéos de visite en drone pour l'immobilier, les entreprises, les hôtels, les bureaux, les lieux, et bien plus encore !",
    ...
    "showreel": "PORTFOLIO",
    "footer_company_name": "DronInside",
    "footer_description": "Faites confiance à nos petites machines volantes pour obtenir les meilleures prises de vue pour votre entreprise 🚁",

...
<footer class="flex bg-gray-800">
  <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
      <div class="flex justify-center text-teal-600">
          ...
          <div class="flex ml-4">{translate("footer_company_name")}</div>
      </div>
      ...
      <ul class="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
          ...
          <li>
              <button class="text-gray-400 transition hover:text-gray-500/75" on:click={()=>goto("/services")}>
                  {translate("services")}
              </button>
          </li>

          <li>
              <button class="text-gray-400 transition hover:text-gray-500/75" on:click={()=>goto("/portfolio")}>
                  {translate("portfolio")}
              </button>
          </li>
